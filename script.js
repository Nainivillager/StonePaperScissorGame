...
const showResult = (userwon, userChoice, compChoice) => {
  let msg = document.querySelector("#msg");
  if (userwon) {
    userScore++;
    userScorem.innerText = userScore;
    msg.innerText = `You Won. Your ${userChoice} won from Computer's ${compChoice}`;
    msg.style.backgroundColor = "green";
    msg.style.color = "white";
  } else {
    compScore++;
    compScorem.innerHTML = compScore;
    msg.innerText = `You lose. Your ${userChoice} lost from Computer's ${compChoice}`;
...
const playGame = (userChoice) => {
  ...
  if (compChoice == userChoice) {
    ...
    showResult(userwon, userChoice, compChoice);
  }
};
